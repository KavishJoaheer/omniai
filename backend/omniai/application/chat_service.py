...
class ChatService:
    ...
    async def stream_message(
        ...
        *,
        ...
        eff_system = system_prompt if system_prompt is not None else (conversation.system_prompt or DEFAULT_SYSTEM_PROMPT)
        ...
        *,
        ...
        if citations:
            ...
            for c in citations:
                ...
                context_lines.append(f"[{c.index}] (source: {c.document_name}) {snippet}")
            context_block = "\n".join(context_lines)
        else:
